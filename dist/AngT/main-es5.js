...
var Page1Component = /** @class */ (function () {
    ...
    Page1Component.prototype.onFocush = function (i) {
        var _this = this;
        setTimeout(function () {
            _this.showUserList = i;
        }, 100);
        this.showUserList = i;
    };
    Page1Component.prototype.onFocushout = function (i) {
        var _this = this;
        setTimeout(function () {
            _this.showUserList = -1;
        }, 200);
    };
    Page1Component.prototype.collapseMe = function (c) {
        if (c == '1') {
            this.cColl2 = '2c';
            this.cColl3 = '3c';
            if (this.cColl1 == '1o') {
    ...
    Page1Component.prototype.bingFrnLogin = function () {
        var _this = this;
        ...
        this.pFrm.valueChanges.subscribe(function (data) {
            _this.logValidationErrors(_this.pFrm);
        });
    };
    Page1Component.prototype.addNewCompany = function () {
        var control = this.pFrm.controls.ownerName;
        control.push(this.fb.group({
            name: ['']
        }));
    };
    Page1Component.prototype.deleteCompany = function (index) {
        var control = this.pFrm.controls.ownerName;
        if (control.length > 1) {
            control.removeAt(index);
        }
    };
    Page1Component.prototype.setValue = function (index, value) {
        var control = this.pFrm.controls.ownerName;
    ...
    Page1Component.prototype.markFormGroupTouched = function (formGroup) {
        var _this = this;
        if (formGroup === void 0) { formGroup = this.pFrm; }
    ...
    Page1Component.prototype.logValidationErrors = function (group) {
        var _this = this;
        if (group === void 0) { group = this.pFrm; }
        Object.keys(group.controls).forEach(function (key) {
            ...
            if (abstractControl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]) {
                ...
                console.log("formErrorsLogin", _this.pFrm);
